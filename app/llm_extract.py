...
def _openai_fields(text: str, needed: list[str]) -> dict:
    ...
    try:
        ...
        user = (
            ...
            '  "page_refs": {"estimated_value_cr":"pN","emd_amount_cr":"pN","tender_type":"pN","scope_summary":"pN","eligibility_conditions":"pN","key_deliverables":"pN"} (the RFP page where each IMPORTANT field is stated, e.g. "p2"; OMIT any field you cannot locate — never guess),\n'
